...
from app.api.v1.endpoints import health, auth, employees, attendance, leaves, payroll, admin, ai_tools, ai_chat, ai_workflows
...
api_router.include_router(admin.router, prefix="/admin", tags=["Administrative Analytics"])
